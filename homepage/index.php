...
<head>
  ...
  <title>NW Seismic - The galaxy inside you</title>
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-lg-0">
        ...
        <h1 class="sitename">NW Seismic</h1>
        <span>.</span>
      </a>

      <nav id="navmenu" class="navmenu">
        <ul>
          <li><a href="#hero" class="active">Who we are<br></a></li>
          <li><a href="#about">Simulation</a></li>
          <li><a href="#contact">Seismic AI</a></li>
        </ul>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center text-center" data-aos="fade-up" data-aos-delay="100">
          <div class="col-xl-6 col-lg-8">
            <h2>the shaking galaxy is inside you</h2>
            <button type="button" class="btn btn-primary btn-lg">View all data</button>
          </div>
        </div>
